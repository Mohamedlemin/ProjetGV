...
color: #d4d4d4;
  ...
  a{
    text-decoration: none;
        ...
        <li ><a href="Rayonh.php" >Rayon</a></li>
          <li><a href="etagerieh.php" >Etagere </a></li>
          <li><a href="Articleh.php" >Article</a></li>
      ...
      <li>les achats   <i class="fa fa-money-check-alt" aria-hidden="true"></i>
       ...
       <li><a href="achate.php">Acheter</a></li>
         ...
         <li><a href="imprimer.php">Imprimer le ticket</a></li>
          ...
          <li><a href="rec.php">la recette du supermarcher </a></li>
        </ul>
      </li>
      <li>Statistique  <i class="fa fa-chart-pie" aria-hidden="true"></i> 
        <ul class="menul">
          <li><a href="ensemble.php">lister tout R,E,A</a></li>
        
            <li><a href="information.php">Les inforamtions</a></li>
               <li><a href="nbr.php" >Nombre des Articles vendus</a></li>
                              <li><a href="ajuser.php" >Les utilisateure</a></li>
